...
namespace Instasharp.Tests
{
    public class ProfileTests
    {
        ...
        public async Task I_can_get_metadata_from_valid_profiles(string usernameOrUrl)
        {
        ...
        public async Task Non_existent_profiles_throw_exceptions(string usernameOrUrl)
        {
